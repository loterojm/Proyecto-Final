...
import { View, Text, Modal, Button, TouchableOpacity, ActivityIndicator, Image } from "react-native";
...
const Auth = () => {
  ...
  const title = isLogin ? "Iniciar Sesion" : "Registrate";
  const buttonTitle = isLogin ? "Iniciar Sesion" : "Registraste";
  const messageText = isLogin ? "No tienes cuenta?" : "Ya tiene una cuenta?";
...
/>
      ...
      <Modal visible={hasError || isLoading} transparent animationType="fade">
        <View style={styles.containerStyle}>
          ...
          <Text style={styles.modalTitle}>{error ? error.toString() : "Loading"}</Text>
